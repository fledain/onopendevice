...
public class AdbCrypto
{
	...
	public static final int[]	SIGNATURE_PADDING_AS_INT	= new int[] { 0x00, 0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
					...
					0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
					0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
					0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x30, 0x21, 0x30, 0x09,
	 ...
	 * 
	 * @param pubkey
	 *            RSAPublicKey object to convert
	 ...
	 * 
	 * @param base64
	 *            Implementation of base 64 conversion interface required by ADB
	 * @param privateKey
	 ...
	 *             If an RSA key factory cannot be found
	 * @throws InvalidKeySpecException
	 *             If a PKCS8 or X509 key spec cannot be found
	 */
	public static AdbCrypto loadAdbKeyPair(AdbBase64 base64, File privateKey, File publicKey) throws IOException,
	 ...
	 * 
	 * @param privateKey
	 *            The file to store the encoded private key
	 * @param publicKey
	 *            The file to store the encoded public key
	 * @throws IOException
