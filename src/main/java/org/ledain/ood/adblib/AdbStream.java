...
public class AdbStream implements Closeable
{
	 ...
	 * 
	 * @param adbConn
	 *            AdbConnection that this stream is running on
	 * @param localId
	 *            Local ID of the stream
	 */
	 ...
	 * 
	 * @throws IOException
	 *             If the connection fails while sending the packet
	 */
	...
	/**
	 * Called by the connection thread to indicate the stream is okay to send
	 * data.
	 */
	void readyForWrite()
	{
	...
	/**
	 * Called by the connection thread to notify that the stream was closed by
	 * the peer.
	 */
	void notifyClose()
	{
	 ...
	 *             If we are unable to wait for data
	 * @throws IOException
	 *             If the stream fails while waiting
	 */
	 ...
	 * 
	 * @param payload
	 *            Payload in the form of a String
	 * @throws IOException
	 *             If the stream fails while sending data
	 * @throws InterruptedException
	 *             If we are unable to wait to send data
	 */
	 ...
	 * 
	 * @param payload
	 *            Payload in the form of a byte array
	 * @throws IOException
	 *             If the stream fails while sending data
	 * @throws InterruptedException
	 *             If we are unable to wait to send data
	 ...
	 *            Payload in the form of a byte array
	 * @param flush
	 *            Specifies whether to send the packet immediately
	 * @throws IOException
	 *             If the stream fails while sending data
	 * @throws InterruptedException
	 *             If we are unable to wait to send data
	 ...
	 * 
	 * @throws IOException
	 *             If the stream fails while sending the close message.
	 */
	@Override
