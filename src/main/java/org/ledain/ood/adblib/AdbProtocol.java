...
public class AdbProtocol
{
	 ...
	 * 
	 * @param type
	 *            Authentication type (see AUTH_TYPE_* constants)
	 * @param data
	...
	/**
	 * Generates an open stream message with the specified local ID and
	 * destination.
	 * 
	 * @param localId
	 *            A unique local ID identifying the stream
	 * @param dest
	 *            The destination of the stream on the target
	 * @return Byte array containing the message
	 ...
	 * 
	 * @param localId
	 *            The unique local ID of the stream
	 * @param remoteId
	 *            The unique remote ID of the stream
	 * @param data
	 *            The data to provide as the write payload
	 * @return Byte array containing the message
	 */
	...
	final static class AdbMessage
	{
		 ...
		 * 
		 * @param in
		 *            InputStream object to read data from
		 * @return An AdbMessage object represented the message read
		 * @throws IOException
		 *             If the stream fails while reading
		 */
